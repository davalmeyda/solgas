<?php
  ...
  function getpltPedido($pedidosDATA, $balon_pedidoSELECT) {
    $plantilla = '<body>
      <table id="encabezado">
        <tr>
          <td>
          ...
          <td style="text-align: center;border: 1px solid #000; width: 150px">
            ...
            <h2 class="name" style="font-size: 14px;">PEDIDO</h2>
            <div>' . $pedidosDATA['DATA'][0]['serie'] . '</div>
          </td>
        </tr>
      </table>
      <br>
      <table style="width: 100%;">
        <tbody>
          <tr>
            ...
            <td>
              <div>' . $pedidosDATA['DATA'][0]['numdoc_cli'] . '</div>
            </td>
            <td style="text-align: center">
              <div class="text-bold">FECHA EMISIÓN</div>
            </td>
            <td style="text-align: center">
              <div>' . date("d/m/Y", strtotime($pedidosDATA['DATA'][0]['fecini_ped'])) . '</div>
            </td>
          </tr>
          <tr>
            <td class="text-bold">
            ...
            <td>
              <div>' . $pedidosDATA['DATA'][0]['nombres_cli'] . '</div>
            </td>
            <td style="text-align: center">
              <div class="text-bold">FECHA VENCIMIENTO</div>
            </td>
            <td style="text-align: center">
              <div>' . date("d/m/Y", strtotime($pedidosDATA['DATA'][0]['fecfin_ped'])) . '</div>
            </td>
          </tr>
          <tr>
            <td class="text-bold">
            ...
            <td>
              <div>' . $pedidosDATA['DATA'][0]['direccion_cli'] . '</div>
            </td>
            <td style="text-align: center">
      ...
      <table class="border-all" style="width: 100%;">
        ...
        $plantilla .= '<tr>
            ...
            <td style="text-align: center;border-right: 1px solid #000">' . $list['id_balped'] . '</td>
            <td style="text-align: left;border-right: 1px solid #000">' . $list['descripcion_balped'] . '</td>
            <td style="text-align: right">' . $list['cantidad_balped'] . '</td>
            <td style="text-align: right">' . $list['precio_unitario'] . '</td>
            <td style="text-align: right">' . $list['valor_balped'] . '</td>
          </tr>';
          $total_ped = $total_ped+$list['valor_balped'];
        }
      $plantilla .= '</tbody>
        <tfooter>
          <tr>
            ...
            <td colspan="2" style="text-align: right">' . number_format(round($total_ped / 1.18, 2), 2) . '</td>
          </tr>
          <tr>
            <td colspan="4" style="text-align: right">I.G.V.</td>
            <td colspan="1" style="text-align: right">S/</td>
            <td colspan="2" style="text-align: right">' . number_format(round($total_ped * 9/59, 2), 2) . '</td>
          </tr>
          <tr>
            <td colspan="4" style="text-align: right">TOTAL</td>
            <td colspan="1" style="text-align: right">S/</td>
            <td colspan="2" style="text-align: right">' . number_format($total_ped, 2) . '</td>
          </tr>
        </tfooter>
      </table>
      <br>
